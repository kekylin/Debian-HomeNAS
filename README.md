...
### 2、执行脚本下载命令并自动运行
  ```shell
wget -O debian-homenas/debian-homenas.sh -q --show-progress https://mirror.ghproxy.com/https://raw.githubusercontent.com/kekylin/debian-homenas/main/debian-homenas.sh && bash debian-homenas/debian-homenas.sh
  ```
### 2、登陆使用
