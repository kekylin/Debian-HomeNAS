...
# 定义主地址和备用地址
MAIN_BASE="https://gitee.com/kekylin/Debian-HomeNAS/raw/test/Shell/"
BACKUP_BASE="https://raw.githubusercontent.com/kekylin/Debian-HomeNAS/refs/heads/test/Shell"
