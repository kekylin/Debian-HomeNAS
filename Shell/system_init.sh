...
deb https://mirrors.tuna.tsinghua.edu.cn/ bookworm-updates main contrib non-free non-free-firmware
deb https://mirrors.tuna.tsinghua.edu.cn/ bookworm-backports main contrib non-free non-free-firmware
